...
target="_blank"; title="html5 speicification"> HTML</a>은 하이퍼텍스트 마크업 언어(HyperText Markup Language라는 의미의 <strong>웹 페이지를 위한 지배적인 마크업 언어다.</strong>
HTML은 제목, 단락, 목록 등과 같은 본문을 위한 구조적 의미를 나타내는 것뿐만 아니라 링크, 인용과 그 밖의 항목으로 구조적 <u>문서를 만들 수 있는 방법</u>을 제공한다.
그리고 이미지와 객체를 내장하고 대화형 양식을 생성하는 데 사용될 수 있다.</p>
  <img src="캡처.PNG" width = 70%></img>
